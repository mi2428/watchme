...
- **`network.wifi_gateway`:** Router used by `probe.gateway.path.ipv4` or `probe.gateway.path.ipv6`, ARP/NDP resolution, and `probe.gateway.icmp.echo`.
